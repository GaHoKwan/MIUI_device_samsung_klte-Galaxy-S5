...
.method private createListAdapter(I)Landroid/widget/ListAdapter;
    ...
    .line 258
    iget-object v1, p0, Lcom/miui/internal/variable/AlertControllerWrapper$AlertParams;->mCursor:Landroid/database/Cursor;

    if-nez v1, :cond_1

    .line 259
    iget-object v1, p0, Lcom/miui/internal/variable/AlertControllerWrapper$AlertParams;->mAdapter:Landroid/widget/ListAdapter;
...
.method private createListView(Lcom/android/internal/app/AlertController;)V
    ...
    .end local p1    # "alertController":Lcom/android/internal/app/AlertController;
    ...
    .line 270
    .local v1, "impl":Lcom/miui/internal/app/AlertControllerImpl;
    iget-object v3, p0, Lcom/miui/internal/variable/AlertControllerWrapper$AlertParams;->mInflater:Landroid/view/LayoutInflater;

    invoke-virtual {v1}, Lcom/miui/internal/app/AlertControllerImpl;->getListLayout()I
    ...
    .line 277
    invoke-virtual {v1}, Lcom/miui/internal/app/AlertControllerImpl;->getMultiChoiceItemLayout()I

    move-result v3

    invoke-direct {p0, v2, v3}, Lcom/miui/internal/variable/AlertControllerWrapper$AlertParams;->createMultiChoiceListAdapter(Landroid/widget/ListView;I)Landroid/widget/ListAdapter;
    ...
    .local v0, "adapter":Landroid/widget/ListAdapter;
    :goto_1
    invoke-virtual {v1, v0}, Lcom/miui/internal/app/AlertControllerImpl;->setAdapter(Landroid/widget/ListAdapter;)V

    .line 286
    iget v3, p0, Lcom/miui/internal/variable/AlertControllerWrapper$AlertParams;->mCheckedItem:I

    invoke-virtual {v1, v3}, Lcom/miui/internal/app/AlertControllerImpl;->setCheckedItem(I)V

    .line 287
    iget-object v3, p0, Lcom/miui/internal/variable/AlertControllerWrapper$AlertParams;->mCheckedItems:[Z

    invoke-virtual {v1, v3}, Lcom/miui/internal/app/AlertControllerImpl;->setCheckedItems([Z)V
    ...
    invoke-direct {v3, p0, v1}, Lcom/miui/internal/variable/AlertControllerWrapper$AlertParams$3;-><init>(Lcom/miui/internal/variable/AlertControllerWrapper$AlertParams;Lcom/miui/internal/app/AlertControllerImpl;)V
    ...
    :cond_3
    :goto_3
    invoke-virtual {v1, v2}, Lcom/miui/internal/app/AlertControllerImpl;->setListView(Landroid/widget/ListView;)V
    ...
    invoke-virtual {v1}, Lcom/miui/internal/app/AlertControllerImpl;->getSingleChoiceItemLayout()I

    move-result v3

    :goto_4
    invoke-direct {p0, v3}, Lcom/miui/internal/variable/AlertControllerWrapper$AlertParams;->createListAdapter(I)Landroid/widget/ListAdapter;
    ...
    .end local v0    # "adapter":Landroid/widget/ListAdapter;
    :cond_5
    invoke-virtual {v1}, Lcom/miui/internal/app/AlertControllerImpl;->getListItemLayout()I
    ...
    invoke-direct {v3, p0, v2, v1}, Lcom/miui/internal/variable/AlertControllerWrapper$AlertParams$4;-><init>(Lcom/miui/internal/variable/AlertControllerWrapper$AlertParams;Landroid/widget/ListView;Lcom/miui/internal/app/AlertControllerImpl;)V
...
.method private createMultiChoiceListAdapter(Landroid/widget/ListView;I)Landroid/widget/ListAdapter;
    ...
    .line 209
    iget-boolean v1, p0, Lcom/miui/internal/variable/AlertControllerWrapper$AlertParams;->mEditMode:Z
