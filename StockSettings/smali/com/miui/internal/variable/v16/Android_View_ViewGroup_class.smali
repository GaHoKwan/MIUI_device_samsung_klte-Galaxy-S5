...
.method protected handleAddInArray(JLandroid/view/ViewGroup;Landroid/view/View;I)V
    .locals 1
    .param p1, "cookie"    # J
    .param p3, "thiz"    # Landroid/view/ViewGroup;
...
.method protected handleOnChildVisibilityChanged(JLandroid/view/ViewGroup;Landroid/view/View;II)V
    ...
    .param p3, "thiz"    # Landroid/view/ViewGroup;
    .param p4, "child"    # Landroid/view/View;
    .param p5, "oldVisibility"    # I
    .param p6, "newVisibility"    # I
...
.method protected initFromAttributes(Landroid/view/ViewGroup;Landroid/content/Context;Landroid/util/AttributeSet;II)V
    .locals 5
    .param p1, "thiz"    # Landroid/view/ViewGroup;
    ...
    .prologue
    .line 170
    sget-object v4, Lcom/miui/internal/variable/v16/Android_View_ViewGroup_class;->R_styleable_ViewGroup:[I
    ...
    .line 176
    .local v2, "attr":I
    invoke-virtual {p0, p1, v2, v1, p2}, Lcom/miui/internal/variable/v16/Android_View_ViewGroup_class;->processAttribute(Landroid/view/ViewGroup;ILandroid/content/res/TypedArray;Landroid/content/Context;)V
...
.method protected processAttribute(Landroid/view/ViewGroup;ILandroid/content/res/TypedArray;Landroid/content/Context;)V
    ...
    .line 183
    sget v2, Lcom/miui/internal/variable/v16/Android_View_ViewGroup_class;->R_styleable_ViewGroup_clipChildren:I
    ...
    .line 185
    :cond_1
    sget v2, Lcom/miui/internal/variable/v16/Android_View_ViewGroup_class;->R_styleable_ViewGroup_clipToPadding:I
    ...
    .line 187
    :cond_2
    sget v2, Lcom/miui/internal/variable/v16/Android_View_ViewGroup_class;->R_styleable_ViewGroup_animationCache:I
    ...
    invoke-virtual {p1, v2}, Landroid/view/ViewGroup;->setAnimationCacheEnabled(Z)V

    goto :goto_0

    .line 189
    :cond_3
    sget v2, Lcom/miui/internal/variable/v16/Android_View_ViewGroup_class;->R_styleable_ViewGroup_persistentDrawingCache:I
    ...
    .line 191
    :cond_4
    sget v2, Lcom/miui/internal/variable/v16/Android_View_ViewGroup_class;->R_styleable_ViewGroup_addStatesFromChildren:I
    ...
    invoke-virtual {p1, v2}, Landroid/view/ViewGroup;->setAddStatesFromChildren(Z)V

    goto :goto_0

    .line 193
    :cond_5
    sget v2, Lcom/miui/internal/variable/v16/Android_View_ViewGroup_class;->R_styleable_ViewGroup_alwaysDrawnWithCache:I
    ...
    invoke-virtual {p1, v2}, Landroid/view/ViewGroup;->setAlwaysDrawnWithCacheEnabled(Z)V

    goto :goto_0

    .line 195
    :cond_6
    sget v2, Lcom/miui/internal/variable/v16/Android_View_ViewGroup_class;->R_styleable_ViewGroup_layoutAnimation:I
    ...
    .line 198
    invoke-static {p4, v1}, Landroid/view/animation/AnimationUtils;->loadLayoutAnimation(Landroid/content/Context;I)Landroid/view/animation/LayoutAnimationController;
    ...
    .end local v1    # "id":I
    :cond_7
    sget v2, Lcom/miui/internal/variable/v16/Android_View_ViewGroup_class;->R_styleable_ViewGroup_descendantFocusability:I

    if-ne p2, v2, :cond_8

    .line 201
    sget-object v2, Lcom/miui/internal/variable/v16/Android_View_ViewGroup_class;->DESCENDANT_FOCUSABILITY_FLAGS:[I
    ...
    .line 202
    :cond_8
    sget v2, Lcom/miui/internal/variable/v16/Android_View_ViewGroup_class;->R_styleable_ViewGroup_splitMotionEvents:I
    ...
    .line 204
    :cond_9
    sget v2, Lcom/miui/internal/variable/v16/Android_View_ViewGroup_class;->R_styleable_ViewGroup_animateLayoutChanges:I
    ...
    .line 206
    .local v0, "animateLayoutChanges":Z
    if-eqz v0, :cond_0
